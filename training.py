...
def scaleData(y_train: np.ndarray, y_test: np.ndarray) -> np.ndarray:
    ...
    :param y_train: numpy.ndarray: The target values of training.
    :param y_test: numpy.ndarray: The target values of test.
...
def pca(y_train: np.ndarray, y_test: np.ndarray) -> np.ndarray:
    ...
    :param y_train: numpy.ndarray: The target values of training.
    :param y:test: numpy.ndarray: The target values of test.
...
def define_eval_metrics(y_test: np.ndarray, predicted: np.ndarray) -> np.ndarray:
    ...
    :param y_test: numpy.ndarray: The true target values of test.
    :param predicted: numpy.ndarray: The predicted target values of test.
